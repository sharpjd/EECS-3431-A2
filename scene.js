...
var kf_cube = [
    new Keyframe(1.0, new Transform(vec3(0.0, 3.0, 6.0), vec3(0.0, 90.0, 0.0), vec3(1.0, 1.0, 1.0))),
    new Keyframe(3.0, new Transform(vec3(0.0, 0.0, 0.0), vec3(0.0, 180.0, 0.0), vec3(1.0, 1.0, 1.0)))
];
...
so_lookAt1.transform.translation = vec3(0.0, 2.0, 20.0);
...
var ac_camera_controller = new AnimationComponent( 
    [
        new Keyframe(6.0, new Transform(vec3(30.0, 3.0, 10.0), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0)))
    ],
    [
        new Callbackframe(3.0, () => { ca_camera_controller.lookObject = so_lookAt1; console.log(ca_camera_controller) }),
    ]
);
...
//ac_camera_controller.isActive = false;
scene.SCENEOBJECTS.push( camera_controller );